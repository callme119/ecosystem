...
return array(
    ...
    'TMPL_PARSE_STRING' => array(
        ...
        '__IMG__'    => __ROOT__ . '/' . MODULE_NAME . '/YunzhiHome/images',
        '__CSS__'    => __ROOT__ . '/' . MODULE_NAME . '/YunzhiHome/css',
        '__JS__'     => __ROOT__ . '/' . MODULE_NAME . '/YunzhiHome/js',
    ),
